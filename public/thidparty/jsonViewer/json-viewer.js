...
var JSONViewer = (function (document) {
    ...
    /** @constructor */
    function JSONViewer() {
        this._defaultChildCollapsed = true;
    ...
    JSONViewer.prototype.showJSON = function (jsonValue, inputMaxLvl, inputColAt) {
        ...
        walkJSONTree(this._dom_container, jsonValue, maxLvl, colAt, 0, this._defaultChildCollapsed);
    };
     ...
     */
    function walkJSONTree(outputParent, value, maxLvl, colAt, lvl, defaultCollapsed) {
                    ...
                    if (typeof item === "object") {
                        ...
                        // array & object
                            ...
                            if (!itemLen) {
                                ...
                                walkJSONTree(li, item, maxLvl, colAt, lvl + 1, defaultCollapsed);
                                li.appendChild(document.createTextNode(itemIsArray ? "]" : "}"));

                                var list = li.querySelector("ul");

                                // Default child collapsed
                                if (defaultCollapsed) {
